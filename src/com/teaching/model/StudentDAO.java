 ...
 * 
 * @see com.teaching.model.Student
...
public class StudentDAO extends BaseHibernateDAO {
	...
	public static final String STUDENT_GPA = "studentGpa";
	...
	public List<Student> findByExample(Student instance) {
		...
		try {
			List<Student> results = (List<Student>) getSession()
					.createCriteria("com.teaching.model.Student")
	...
	public List<Student> findByStudentGpa(Object studentGpa) {
		return findByProperty(STUDENT_GPA, studentGpa);
	}
