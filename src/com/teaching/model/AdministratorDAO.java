 ...
 * 
 * @see com.teaching.model.Administrator
...
public class AdministratorDAO extends BaseHibernateDAO {
	...
	// property constants
	public static final String ADMIN_WORK_LENGTH = "adminWorkLength";
	...
	public Administrator findById(java.lang.Integer id) {
		...
		try {
			Administrator instance = (Administrator) getSession().get(
					"com.teaching.model.Administrator", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Administrator> findByExample(Administrator instance) {
		...
		try {
			List<Administrator> results = (List<Administrator>) getSession()
					.createCriteria("com.teaching.model.Administrator")
	...
	public List<Administrator> findByAdminWorkLength(Object adminWorkLength) {
		return findByProperty(ADMIN_WORK_LENGTH, adminWorkLength);
	}
