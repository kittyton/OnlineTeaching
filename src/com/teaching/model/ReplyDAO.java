...
public class ReplyDAO extends BaseHibernateDAO {
	...
	public List<Reply> findByExample(Reply instance) {
		...
		try {
			List<Reply> results = (List<Reply>) getSession()
					.createCriteria("com.teaching.model.Reply")
	...
	public List<Reply> findByReplyTime(Object replyTime) {
